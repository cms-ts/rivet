...
namespace Rivet {
  ...
  class CMS_2016_SMP_14_010 : public Analysis {
  public:
    
    /// Constructor
    CMS_2016_SMP_14_010()
      : Analysis("CMS_2016_SMP_14_010")
    { 
    ...
    void init() {
      ...
      _h_first_bjet_abseta_b = bookHisto1D(2,1,1);
      _h_Z_pt_b = bookHisto1D(3,1,1);
      _h_HT_b = bookHisto1D(4,1,1);
      _h_Dphi_Zb_b = bookHisto1D(5,1,1);
      
      _h_first_jet_pt_ratio = bookScatter2D(6,1,1);
      _h_first_jet_abseta_ratio = bookScatter2D(7,1,1);
      _h_Z_pt_ratio = bookScatter2D(8,1,1);
      _h_HT_ratio = bookScatter2D(9,1,1);
      _h_Dphi_Zj_ratio = bookScatter2D(10,1,1);
      
      _h_first_jet_pt = boost::make_shared<YODA::Histo1D>(*_h_first_bjet_pt_b);
      _h_first_jet_abseta = boost::make_shared<YODA::Histo1D>(*_h_first_bjet_abseta_b);
      _h_Z_pt = boost::make_shared<YODA::Histo1D>(*_h_Z_pt_b);
      _h_HT = boost::make_shared<YODA::Histo1D>(*_h_HT_b);
      _h_Dphi_Zj = boost::make_shared<YODA::Histo1D>(*_h_Dphi_Zb_b);
  ...
  DECLARE_RIVET_PLUGIN(CMS_2016_SMP_14_010);
