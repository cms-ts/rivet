...
namespace Rivet
{
  ...
  public:
    ...
    /// Constructor
    CMS_2015_I1310737():Analysis("CMS_2015_I1310737")
    {
  ...
  public:
    ...
    void init()
    {
      ...
      _h_excmult_jets_tot = bookHistogram1D(1, 1, 1);
      _h_incmult_jets_tot = bookHistogram1D(2, 1, 1);
      _h_leading_jet_pt_tot = bookHistogram1D(3, 1, 1);
      _h_second_jet_pt_tot = bookHistogram1D(4, 1, 1);
      _h_third_jet_pt_tot = bookHistogram1D(5, 1, 1);
      _h_fourth_jet_pt_tot = bookHistogram1D(6, 1, 1);
      _h_leading_jet_eta_tot = bookHistogram1D(7, 1, 1);
      _h_second_jet_eta_tot = bookHistogram1D(8, 1, 1);
      _h_third_jet_eta_tot = bookHistogram1D(9, 1, 1);
      _h_fourth_jet_eta_tot = bookHistogram1D(10, 1, 1);
      _h_ht1_tot = bookHistogram1D(11, 1, 1);
      _h_ht2_tot = bookHistogram1D(12, 1, 1);
      _h_ht3_tot = bookHistogram1D(13, 1, 1);
      _h_ht4_tot = bookHistogram1D(14, 1, 1);
  ...
  AnalysisBuilder<CMS_2015_I1310737> plugin_CMS_2015_I1310737;
